...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-between gap-5  w-full items-center">
      <NavBar />
      <div className="opacity-90 flex flex-row fixed bottom-5 right-5 lg:bottom-20 lg:right-24 z-30 items-center justify-center bg-[#F6D50E] w-14 h-14 rounded-full shadow-lg border ring border-[#14ABD5]">
